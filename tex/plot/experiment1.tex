    ...
    \begin{adjustbox}{width=1\textwidth, center}
        ...
        \begin{tikzpicture}
            \begin{axis}[
                ...
                table[y error index=2]{plot/host_theoretical.dat};

                \addplot [color=blue, mark=o]
                plot [error bars/.cd, y dir = both, y explicit]
                table[y error index=2]{plot/host_ostinato.dat};

                \addplot [style=thick, color=red, mark=o]
                plot [error bars/.cd, y dir = both, y explicit]
                table[y error index=2]{plot/host_mausezahn.dat};

                \addplot [color=green, mark=o]
                plot [error bars/.cd, y dir = both, y explicit]
                table[y error index=2]{plot/host_iperf.dat};
